...
import Heading from "../Heading1/Heading";
...
export default function Dessert() {
  return (
    <section className="w-full  bg-white mx-auto mt-[80px] sm:mt-[120px] px-4">
